...
function InformationSection() {
  const content = [
    ...
    'We belive in work today for future ideology, so that our children can get fresh Air and Clean Earth to live .',
  ];
        ...
        <div className=' ml-[20vw]'>
          ...
          <div className='flex flex-col space-y-2'>
            {socialMedia.map((platform, index) => (
              <a key={index} href={`https://${platform.toLowerCase()}.com`} className='text-lg capitalize font-light underline'>
                {platform}
              </a>
            ))}
          </div>
