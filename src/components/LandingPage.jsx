      ...
      <div className='textStructure mt-32 px-20'>
        {["We Create","Solution","For Garbage"].map((item,index)=>{
            return (
                ...
                <div className='w-fit flex items-end overflow-hidden'>
                  ...
                  <h1 className='-mb-[1vw] uppercase text-[5.86vw] leading-[8vw] font-["Founders_Grotesk "] font-bold'>{item}</h1>
                </div>
              </div>
        ...
        <div className='border-t-[1px] border-zinc-700 mt-32 py-5 px-20 flex justify-between items-center'>
          ...
          <div className='start flex items-center gap-5'>
            <div className='px-5 py-2 border-[2px] border-zinc-500 rounded-full font-light text-md uppercase'>Book a Pick-up</div>
